...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/index5.tsx");
/******/ })
/************************************************************************/
/******/ ({
...
class ChildApp extends React.Component {
    //public state: CSTATE={}
    render() {
        const CHDOM = this.props.data.map((v, i) => {
            return (React.createElement("span", { key: i },
                "title is ",
                v.title));
        });
        //const CHDOM = <div>test</div>
        return (React.createElement("li", null, CHDOM));
    }
}
class AppComponent extends React.Component {
    ...
    render() {
        return (React.createElement("div", null,
            React.createElement(ChildApp, { data: this.state.questions }),
            React.createElement("span", null, this.props.fuga),
            React.createElement("input", { type: "text", ref: this.textInput }),
            React.createElement("button", { onClick: () => { this.props.dom_o_click(this.textInput.current.value); } }, "OnClick")));
    }
    componentDidMount() {
...
const App = (() => {
    ...
    return react_redux_1.connect(mapStateProps, mapDispatchToProps)(AppComponent);
})();
/**
 * reducer
 */
