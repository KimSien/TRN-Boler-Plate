...
class App extends React.Component {
    render() {
        return (React.createElement("div", null,
            ...
            React.createElement("button", { onClick: () => this.props.Increment_Click() }, "\uFF0A\u5897\u52A0\uFF0A"),
            React.createElement("button", { onClick: () => this.props.Decrement_Click() }, "\uFF0A\u6E1B\u5C11\uFF0A")));
    }
}
exports.default = App;
...
const action_1 = __webpack_require__(/*! ../actions/action */ "./src/actions/action.tsx");
...
function mapDispatchToProps(dispatch) {
    return {
        Increment_Click: () => { dispatch(action_1.default.increment()); },
        Decrement_Click: () => { dispatch(action_1.default.decrement()); }
    };
}
exports.default = react_redux_1.connect(//これが子コンポーネントで使える要素（props）
mapStateToProps, mapDispatchToProps)(app_1.default);
...
const index_1 = __webpack_require__(/*! ../reducers/index */ "./src/reducers/index.tsx");
